...
public class DataBase {
    ...
    public DataBase() {
        ...
        palcos.add(palco1);
        Palco palco2 = new Palco("Palco Cultura Popular", "Sem descrição", "11111", "2222222", 2, R.drawable.culturapop1);
        palcos.add(palco2);
        Palco palco3 = new Palco("Palco Instrumental", "Parque Ruber Van Der Linden ", "11111", "2222222", 3, R.drawable.pinst1);
        palcos.add(palco3);
        Palco palco4 = new Palco("Palco Pop", "Parque Euclides Dourado", "11111", "2222222", 4, R.drawable.forro1);
        palcos.add(palco4);
        Palco palco5 = new Palco("Palco Forró", "Parque Euclides Dourado", "11111", "2222222", 5, R.drawable.forro1);
        palcos.add(palco5);
        Palco palco6 = new Palco("Palco Som na Rural", "Parque Euclides Dourado", "11111", "2222222", 6, R.drawable.fig1);
        palcos.add(palco6);
        Palco palco7 = new Palco("Palco Mamulengos e Pontos de Cultura", "Parque Euclides Dourado", "11111", "2222222", 7, R.drawable.fig1);
        palcos.add(palco7);
        ...
        PontoTuristico ptur = new PontoTuristico("Parque Ruber Van Der Linden", " R. Manoel Clemente - Santo Antônio, Garanhuns - PE, 55290-000", -8.8929469, -36.5609063, R.drawable.paupombo1);
        pontosTuristicos.add(ptur);
        ptur = new PontoTuristico("Relógio de Flores", "Heliópolis, Garanhuns - PE, 55290-000", -8.8816533, -36.4856628, R.drawable.relogio);
        pontosTuristicos.add(ptur);
        ptur = new PontoTuristico("Fonte Luminosa", "Santo Antônio, Garanhuns - PE, 55290-000", -8.8816533, -36.4856628, R.drawable.fonte);
        pontosTuristicos.add(ptur);
        ptur = new PontoTuristico("Centro Cultural Alfredo Leite Cavalcanti", "Santo Antônio, Garanhuns - PE, 55290-000", -8.8816533, -36.4856628, R.drawable.centrocultural);
        pontosTuristicos.add(ptur);
        ptur = new PontoTuristico("Castelo de João Capão", "José Maria Dourado, Garanhuns - PE, 55290-000", -8.8873349, -36.4953187, R.drawable.castelo);
        pontosTuristicos.add(ptur);
        ptur = new PontoTuristico("Cristo do Magano", "Magano, Garanhuns - PE", -8.8921024, -36.4995397, R.drawable.cristo);
        pontosTuristicos.add(ptur);
        ptur = new PontoTuristico("Santuario Mãe Rainha", "Severiano Moraes Filho, Garanhuns - PE", -8.8861472, -36.4545896, R.drawable.mae_rainha);
        pontosTuristicos.add(ptur);
        ptur = new PontoTuristico("Parque Euclides Dourado", "Av. Júlio Brasileiro, 363-425 - Heliópolis, Garanhuns - PE, 55295-475", -8.8845927, -36.4868788, R.drawable.edourado1);
        pontosTuristicos.add(ptur);
        ptur = new PontoTuristico("Mosteiro de São Bento", "Praça Tiradentes, 1223 - São José, Garanhuns - PE, 55290-000", -8.8878763, -36.496458, R.drawable.mosteiro);
        pontosTuristicos.add(ptur);
        ...
        PoloProgramacao programacao = new PoloProgramacao("Rosa Choque", "18h", "TEATRO ADULTO", dia1.id);
        polo.programacoes.add(programacao);
        programacao = new PoloProgramacao("Cena Circo: Mostra de Números Circenses", "16h", "CIRCO", dia1.id);
        polo.programacoes.add(programacao);
        programacao = new PoloProgramacao("Cabaret Brecht, canções de Kurt Weill e Bertolt Brecht", "17h", "PROGRAMAÇÃO ESPECIAL", dia1.id);
        polo.programacoes.add(programacao);
        programacao = new PoloProgramacao("A Erudita", "18h30", "TEATRO ADULTO", dia1.id);
        polo.programacoes.add(programacao);
        programacao = new PoloProgramacao("Bate-papo \"A influência dos contos de Caio Fernando Abreu e Marcelino Freire\"", "20h", "LITERATURA NA CENA", dia1.id);
        polo.programacoes.add(programacao);
        programacao = new PoloProgramacao("Réquiem para um rapaz triste", "22h", "LITERATURA NA CENA", dia1.id);
        polo.programacoes.add(programacao);
        programacao = new PoloProgramacao("Bicha Oca", "23h30", "LITERATURA NA CENA", dia1.id);
        polo.programacoes.add(programacao);
        polos.add(polo);
